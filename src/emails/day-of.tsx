...
export default function DayOfEmail({
  firstName, eventTime, locationName, address, eventDetailLink, unsubscribeUrl,
}: DayOfEmailProps) {
  return (
    <Html><Head />
      <Preview>See you tonight at {locationName}.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            <Heading style={heading}>Today's the day.</Heading>
            <Text style={subheading}>LINK'D UP starts at {eventTime}. See you tonight.</Text>
          </Section>
          <Section style={card}>
            <Text style={cardLabel}>TONIGHT'S EVENT</Text>
            <Text style={cardDetail}>LINK'D UP</Text>
            <Text style={cardDetail}>Tonight · {eventTime}</Text>
            <Text style={cardDetail}>{locationName}</Text>
            <Text style={cardDetailMuted}>{address}</Text>
          </Section>
          <Section style={bodySection}>
            <Text style={bodyText}>
              Hey {firstName} — tonight is the night.
            </Text>
            <Text style={bodyText}>
              Come ready to meet people, exchange ideas, support local creatives, talk business, and enjoy the atmosphere.
            </Text>
            <Text style={bodyText}>
              Bring a friend, partner, colleague, or collaborator. The more people in the room, the more opportunities for everyone.
            </Text>
            <Text style={{ ...bodyText, color: '#a8d8f0', fontWeight: '600' }}>
              We'll see you at {locationName} at {eventTime}.
            </Text>
          </Section>
          <Section style={ctaSection}>
            <Button style={primaryButton} href={eventDetailLink}>Open Event Details</Button>
          </Section>
          <Hr style={hr} />
...
const heading = { color: '#ffffff', fontSize: '40px', fontWeight: '800', margin: '0 0 12px', letterSpacing: '-0.5px' }
